...
export default function Galary() {
  const images = [
    ...
    {
      src: "./images/Gemini_Generated_Image_bwu0dcbwu0dcbwu0.webp",
    ...
    {
      src: "./images/Gemini_Generated_Image_kjpg6ikjpg6ikjpg.webp",
    ...
    {
      src: "./images/Generated Image October 12, 2025 - 5_02PM.webp",
    ...
    {
      src: "./images/Gemini_Generated_Image_ttkt2mttkt2mttkt.webp",
    ...
    {
      src: "./images/Generated Image October 12, 2025 - 5_19PM.webp",
      alt: "Brown paper delivery bag next to various meal boxes",
      class: "col-span-1 row-span-3",
    }, // Image 6: Bottom-Center-Right (Original Chicken on Plate, bottom-right of the collage) // NOTE: Using the 6th available import for the bottom right slot.

    {
      src: "./images/WhatsApp Image 2025-10-12 at 4.36.40 PM.webp",
    ...
    {
      src: "./images/Gemini_Generated_Image_of1u83of1u83of1u.webp",
      alt: "Grilled chicken with a sauce and garnish on a white plate",
      class: "col-span-1 row-span-2",
    },
    ...
    <section className="py-8 p-10">
      ...
      <div className="mt-12 grid grid-cols-3 lg:grid-cols-[repeat(3,300px)] grid-rows-6 justify-center gap-4  px-2 auto-rows-fr h-[300px] lg:h-[600px]">
        ...
        {displayImages.map((image, index) => (
          <div
            key={index} // Apply the unique span class and standard styling

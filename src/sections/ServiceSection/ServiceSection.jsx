...
function ServiceSection() {
  return (
    <section className="bg-pattern relative w-full h-[600px] sm:h-[700px] md:h-[600px] mb-20 flex flex-col items-center justify-end overflow-hidden bg-[color:var(--color-background)] text-[color:var(--color-foreground)]">
      ...
      <div className="absolute top-12 left-0 w-full h-full text-left px-4 sm:px-6 md:px-12">
        <div className="relative w-full h-full">
          ...
          <p className="text-sm sm:text-base md:text-lg font-body text-[color:var(--color-muted)] mb-4 max-w-xl">
          ...
          <div className="mt-3 absolute bottom-24 sm:bottom-20 left-0 w-[90%] sm:w-80 border p-4 sm:p-5 rounded-2xl bg-white shadow-md">
          ...
          {/* Top right info box */}
          <div className="mt-5 absolute top-0 right-0 w-[90%] sm:w-72 md:w-80 border p-4 sm:p-5 rounded-2xl bg-white shadow-md text-center">
            <p className="font-semibold uppercase mb-3 text-lg sm:text-base md:text-lg">
              Currently Serving
            </p>
            <div className="flex flex-col gap-2 sm:gap-3">
              {["Taramani", "Velachery", "OMR", "Perungudi", "Thoraipakkam"].map(
                (item, index) => (
                  <p
                    key={index}
                    className="mb-1 text-[#000] text-sm sm:text-base cursor-pointer hover:text-[color:var(--color-secondary)]"
                  >
                    {item}
                  </p>
                )
      ...
      <div className="relative h-[600px] sm:h-[700px] md:h-[600px] w-full flex items-end justify-center overflow-hidden">
        {/* Outer Half Circle */}
        <div className="absolute bottom-0 w-[250px] sm:w-[400px] md:w-[500px] h-[125px] sm:h-[200px] md:h-[250px] border-2 sm:border-3 border-dashed border-[color:var(--color-secondary)] rounded-t-full border-b-0">
        ...
        <img
          src="/images/shop.png"
          alt="shop"
          className="w-12 h-12 sm:w-16 sm:h-16 md:w-16 md:h-16 object-contain z-10 mb-2"
        />
      </div>
    </section>
  );
